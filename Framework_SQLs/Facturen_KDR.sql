WITH 
CHILD_LEVEL AS 
(SELECT DIM_KDR_KPL_ORG_HIER_ID, KOSTENDRAGER_KIND, ORGANISATIE_BK_VADER, ORGANISATIE_KIND, ORGANISATIE_BK_KIND, HR_NIVEAU FROM DMT.DIM_KDR_KPL_ORG_HIER WHERE KOSTENDRAGER_KIND LIKE 'B6%'),
HIERARCHIE AS (
SELECT 
...
INNER JOIN DMT.DIM_LEVERANCIER LEV ON FCT_FAC.DIM_LEVERANCIER_ID = LEV.DIM_LEVERANCIER_ID
